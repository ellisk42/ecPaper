...
\\\bottomrule\\
  ...
  \caption{The DSL induction algorithm proposes fragments of programs to add to the DSL.
    These fragments are taken from programs in the frontiers (left column).
    Here, the proposed subexpression (top) slice from the beginning of a
    list or (bottom) performs character substitutions.} 
