...
Lisp-style functions on lists;
FlashFill-style~\cite{gulwani2011automating} string processing; and
symbolic regression;
For each of these we initially provide a generic
set of programming primitives in a Lisp-like language. % TODO: we don't actually give lisp primitives for regression..
