...
, the program synthesis and AI communities have had many successes,
...
\end{tabular}}
\caption{Top: Example tasks from each domain, each followed by the programs \system discovers for them. Bottom: Subset of learned DSL. Notice that learned DSL primitives can call each other ($f_1$/$f_2$ in Strings \& Regression)}
\end{figure}
...
Synthesizing programs that edit strings is a classic problem in the
