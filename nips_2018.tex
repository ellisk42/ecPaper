...
\begin{tabular}{l}
  ...
  $f_2($\code{x}$)\,=\,$\code{(/ (/ x real) x)}
  \\\bottomrule
\end{tabular}
\caption{Some learned subroutines for symbolic regression. The system starts with addition, multiplication, division, and real numbers, and learns to build rational functions and polynomials up to 4th order.}\label{regressionDSL}
\end{wrapfigure}
