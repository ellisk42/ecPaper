...
\textbf{Compile: learning to tractably maximize $\lowerBound$ w.r.t. the
...
\begin{wrapfigure}{r}{0.6\textwidth}\vspace{-0.55cm}\centering
  \begin{tikzpicture}[scale=0.9]
    ...
    \draw [->,thick,dashed] (DSL.north) to[out = 90,in = 180] node[fill=white,inner sep=0pt,align = center]{  \footnotesize{Inductive bias}\\\footnotesize{(Explore)}} (synthesis.west);
    \draw [->,thick,dashed] (recognitionModel.north) to[out = 90,in = 0] node[fill=white,inner sep=0pt,align = center]{{\footnotesize Makes tractable}\\{\footnotesize (Explore)}} (synthesis.east);
  \end{scope}}
    \end{tikzpicture}
...
\begin{wrapfigure}{r}{0.55\textwidth}\vspace{-0.5cm} \newcommand{\functionSize}{1.5cm}\centering
