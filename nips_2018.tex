...
\begin{table}[hb]
  ...
  \begin{tabular}{>{\hspace{-1em}}c<{\hspace{-1em}}>{\hspace{-2.5em}}c<{\hspace{-0.8em}}>{\hspace{-1em}}c<{\hspace{-1em}}}
    ...
    {\tabcolsep=4pt
      \begin{tabular}{cc}
        \begin{tabular}{c}
          \code{[7\, 0\, 2]}$\to $\code{[7\, 0\, 2\, 4]}         \\
          \code{[2\, 4\, 9\, 3]}$\to $\code{[3\, 9\, 4\, 2\, 4]} \\
        ...
        \hspace{-0.3cm}\begin{tabular}{c}
          ...
          \hspace{-0.3cm}\code{[9\, 4\, 4]}$\to $\code{True\phantom{e}} \\
          \hspace{0.3cm}\code{[4]}$\to $\code{True\phantom{e}}                        \\
          \hspace{-0.3cm}\code{[4\, 7\, 3]}$\to $\code{True\phantom{e}}                \\
    ...
    \hspace{1cm}\begin{tabular}{l}
      ...
      \vspace{2ex}
      \hspace{\helpSize}($f_1$: \emph{Append }\code{k}\emph{ to $\ell$})\\
