...
\usepackage{xcolor}
\definecolor{pop1}{HTML}{1b9e77}
\definecolor{pop2}{HTML}{7570b3}
...
\centering  \begin{minipage}[c]{0.2\textwidth}
  \begin{tikzpicture}[scale=0.7]
    ...
    \node [rotate=90] at (-2.3,-0.5) {\small program};
          ...
          \node(l1) at (0,0) {};
  \node[color=pop1](p1) at (-1,-1) {\code{+}};
  \node[color=pop1](n1) at (0.7,-0.9) {\code{1}};
  \node(x1) at (0,-1) {\code{1}};
  \draw[color=pop1] (l1.south) -- (p1.north);
  \draw[color=pop1] (l1.south) -- (n1.north);
  \draw[color=pop1] (-0.5,-0.5) -- (x1.north);
...
\begin{scope}[shift={(0,-5)}]
  \node[pop1](p1) at (-1,-1) {\code{+}};
  \node[pop1](n1) at (0.8,-0.7) {\code{1}};
  \node[pop1](a) at (0,-1) {\code{ }};
  %\node(x1) at (0,-1) {};
  \draw[pop1] (0,0) -- (p1.north);
  \draw[pop1] (0,0) -- (n1.north);
  \draw[pop1] (-0.55,-0.4) -- (a.north);
