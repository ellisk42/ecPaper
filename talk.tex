...
\begin{frame}{Turtle graphics --- Learning curves and dreams}
  \centering
  \includegraphics[width=9cm]{figures/dreams/montageTalk.eps}
\end{frame}

\begin{frame}{Turtle graphics --- Improved DSL}
  \begin{itemize}
...
\begin{frame}{Vision}
  ...
  %%   \end{itemize}
    ...
    \begin{figure}
        \includegraphics[scale=0.44]{figures/xkcd_star.png}
        \caption*{Thanks to \textsc{xkcd} we can rule out $36^\circ$ as a primitive.}
    \end{figure}
