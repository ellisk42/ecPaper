...
\begin{frame}{Turtle graphics --- Generative model}
  \centering
  \only<1>{
    \begin{figure}
...
\begin{frame}{Turtle graphics --- All the way down}
  ...
  \only<1>{
  \begin{tikzpicture}
      \node at(-10,0) {\includegraphics[width=5cm]{figures/marieSequences.png}};
      \node at(-4,0) {\includegraphics[width=5cm]{figures/teachLogo/star5_black.eps}};
    \node at (-10,-4) {Marie Amalric, Stanislas Dehaene et al.};
    \end{tikzpicture}
  }
  \only<2>{
    \begin{figure}
