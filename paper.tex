...
Instead, we provide array/string indexing primitives (\code{slice}, \code{nth}),
...
\begin{table}[t]
  ...
  \begin{tabular}{c}
    ...
    \code{split}, \code{join}, \code{map}, \code{length}, \code{slice}\\
    \code{append}, \code{chr->str}, \code{trim}, \code{nth}\\
    \code{lowercase}, \code{uppercase}, \code{capitalize}\\
