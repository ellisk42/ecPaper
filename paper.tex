...
At first, \system cannot find programs for most of the tasks.
...
Our full model consistently beats the baselines.
Lesioning the recognition model slows down the convergence of the algorithm,
