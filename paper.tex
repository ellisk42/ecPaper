...
each off other (Fig.~\ref{feeding}):
...
update the recognition model training on two data sources: samples
...
some domains over the generic methods used here, and to
...
including the four domains considered but many others?
\bibliography{main}
