...
specific knowledge about the space of programs to be considered. In
practice
we are often given only one or a few examples of each
...
construct a richer, more powerful and better-tuned domain-specific
language.
...
This wake/sleep style of inference is the reason why we call our approach \systemEnding.
