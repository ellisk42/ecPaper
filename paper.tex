...
which alternates between ``waking'', or training a generative model (our $\mathcal{D},\theta$),
and  ``sleeping'', or training a recognition model on samples from the generative model (our $q$).
