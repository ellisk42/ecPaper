...
DSL, by providing a crucial inductive bias for what would otherwise be an
...
\section{Related Work}
 ...
 We contribute a model, \systemEnding, that learns to program by
 ...
 DSL and hone in on the right programs.
 ...
 program induction.
Many directions remain open for future work. Two immediate goals are to
integrate more sophisticated neural recognition models~\cite{devlin2017robustfill} and
program synthesizers~\cite{solar2008program}, which may improve performance in some
domains over the generic methods used here, and to explore DSL
meta-learning: Can we find a single universal primitive set that could
effectively bootstrap DSLs for new domains, including the four domains
