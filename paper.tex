...
agent can solve and how quickly can find those solutions.
...
real numbers were used in the programs: did the model correctly explain a linear function
...
\pagebreak
 ...
 bootstrapping a domain-specific language.
 The  DSL learns to expose new domain-specific primitives
