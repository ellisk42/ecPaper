...
\begin{abstract}
  ...
  hand-engineered  domain-specific languaget (DSL),
  ...
  that learns the DSL called \system,
which infers
  a DSL 
...
\begin{tabular}{| l | l | l |}
  ...
  \hline
\end{tabular}
\caption{Examples of simple tasks from our list function domain. We used
  15 input/output examples for each task to reduce ambiguity in the task's
  function, ensuring solutions achieve the desired concept.}
\label{listexamples}
\end{table}
...
\includegraphics[width = 7cm]{figures/regression.eps}
  \includegraphics[width = 7cm]{figures/list.eps}
