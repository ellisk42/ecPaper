...
the agent solve other related program induction problems. The neural
...
\begin{tabular}{l}
  ...
  \\\bottomrule
\end{tabular}
\caption{Some learned DSL primitives for symbolic regression. System starts out with addition, multiplication, and real numbers, and learns to build 4th order polynomials.}\label{regressionDSL}
\end{table}
...
\\\noindent \textbf{Ours (no $q$)}, which lesions the recognition model, $q$.
