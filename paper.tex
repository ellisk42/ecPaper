...
A DSL $\mathcal{D}$
samples a latent program $p$
which determines the agent's observations, $x$.
...
In tandem we learn a learn a neural network $q$ that regresses
from observations to programs.
We will show that the interaction of
the generative and recognition models is important for solving these program induction problems.
...
Figure~\ref{circuitLearningCurve} 
