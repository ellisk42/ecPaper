...
%%   \end{tikzpicture}
  ...
  Observe \textbf{tasks} (program induction problems). 
  Solve tasks w/ latent programs.
  ...
  \textbf{Recognition model}: a neural net that predicts distribution over programs conditioned on task: `procedural knowledge'
