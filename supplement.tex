...
%% The brifly presented geometry project is a recent addition to the set
%% of problems adressed with our method.

%% The original DSL, while inspired by the in the sense that ones
%% controls a moving on-off point, was designed to be congitively
%% plausible in the sense that some abstractions are baked in for curves
%% and a few structures ---

%% It is to be thought as a turtle with as internal state a position, a
%% facing direction, a speed, an acceleration, an angular speed and an
...
\begin{figure}[htp]
  \begin{center}
  \includegraphics[width = 0.75\textwidth]{figures/moreDreams.png}
  \end{center}
