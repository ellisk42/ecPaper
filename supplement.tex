...
We show representative problems:
\pagebreak
...
Extract string delimited by ',' (inclusive),' '
\begin{tabular}{ll}
        \toprule Input&Output\\\midrule
LsR,uhMZI wIL & ,uhMZI  \\
 tMY,KdF hhT & ,KdF  \\
...
Apply first 2 characters to input delimited by '.'
\begin{tabular}{ll}
        \toprule Input&Output\\\midrule
...
Apply first 2 characters to string delimited by ' ','.'
\begin{tabular}{ll}
        \toprule Input&Output\\\midrule
fNA YWyL.JDD & YW \\
 YWozt TPW.nczz & TP \\
...
%% Apply double to input delimited by '.'
%% \begin{tabular}{ll}
%%         \toprule Input&Output\\\midrule
%% FWhb.jYMdi & FWhbFWhbjYMdijYMdi \\
%%  JZB.WEwgH & JZBJZBWEwgHWEwgH \\
%%  SgA.Kxo.RyF & SgASgAKxoKxoRyFRyF \\
%%  NMApj.OaPBs.uZm.iCZy & NMApjNMApjOaPBsOaPBsuZmuZmiCZyiCZy
%% \\\bottomrule
%% \end{tabular}


Apply strip to string delimited by ',','.'
\begin{tabular}{ll}
        \toprule Input&Output\\\midrule
iNEP,  GigW .Xlm & GigW \\
...
Differentiate with respect to $\theta_e$:
\begin{align}
