...
\begin{block}{Generative models of images: Turtle/LOGO Graphics}
  ...
  \begin{tabular}{|lll|}\multicolumn{3}{c}{\textbf{12 (of 132) Tasks}}\\\hline
...
%    \includegraphics[width = \dreamSize]{dreams/final/trimmed/1748505267_norm.png}&
  ...
  \vspace{2cm} \emph{Left:}  Agent controls a `pen' -- tasked with drawing pictures. \\\emph{Right:} During Sleep-R,
  agent `dreams' by sampling programs from learned DSL and rendering them.
...
\begin{block}{Generative models of text}
    Learn probabilistic program: a stochastic regex\begin{figure}
\centering
%\tiny
\tabcolsep=2pt
\vspace{0pt}
