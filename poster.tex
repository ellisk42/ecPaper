...
\begin{alertblock}{Wake/Sleep DSL Induction}
  ...
  Lisp-like; conditionals, variables, local functions
...
Fragment grammars: first introduced in computational linguistics~\cite{tim}
...
\begin{block}{Ongoing work: Generative models for text}
\begin{figure}
\centering
\tiny
\tabcolsep=2pt
