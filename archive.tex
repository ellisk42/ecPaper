...
\title{\systemEnding: A Wake/Sleep Algorithm for Developing Domain Expertise}
\date{}
\begin{document}
\maketitle{}
...
it. It gradually grows its domain-specific knowledge for a
class of problems by assembling a library of code containing concepts
useful for the domain, while jointly training a neural network to quickly
...
&\raisebox{-.5\height}{\includegraphics[width = 0.3\textwidth]{figures/logo_primitives/logo_primitive_12.png}}
    ...
    \multicolumn{2}{c}{
      \begin{tabular}{ccc}
        Dreams before learning&Dreams after learning&Dreams after learning (cherry picked)\\
          \includegraphics[width = 0.3\textwidth]{figures/dreams/beforeLearning25}&
          \includegraphics[width = 0.3\textwidth]{figures/dreams/final25}&
          \includegraphics[width = 0.3\textwidth]{figures/dreams/cherry_picked/montage}
      \end{tabular}
    }
  \end{tabular}
