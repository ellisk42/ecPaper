...
\begin{figure}\centering
  \begin{tikzpicture}
    ...
    \begin{scope}[shift={(0,8)}]
      ...
      \node[rotate=90,align=center] at ([xshift=-2cm]p1.center) {\texttt{\textbf{Progs.}}\\};
      ...
      \draw[->] ([yshift=0.35cm,xshift=-0.3cm]p1.south) to[out=250] (filter.north);
      \draw[->] ([yshift=0.0cm,xshift=0.3cm]p1.south) to[out=350,in=100] (for.west);
      \draw[->] ([xshift=-0.7cm]p2.south) -- (single.north);
