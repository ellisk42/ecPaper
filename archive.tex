...
We first task \system with inferring 57 equations describing physical laws,
  ...
  \begin{tabular}{lll}\toprule
    ...
    \begin{tabular}{l}
      \begin{tabular}{l}
        ...
        \code{1, [0 2 -1]$\to$2.5}\\
        \code{2, [2 1 3]$\to$14}\\
        \blueCode{$f(m$, $\vec{v}) = $($f_4$ (* $m$ ($f_0$ $\vec{v}$)))}
      ...
      \begin{tabular}{l}
        ...
        \hspace{0.2cm}\blueCode{($f_7$ $q_1$ $q_2$ (zip $\vec{r}_1$ $\vec{r}_2$ ($\lambda$ (x y) (- x y))))}
      \end{tabular}\\\\
      \begin{tabular}{l}
    ...
    \begin{tabular}{l}
      \begin{tabular}{l}
        ...
        \hspace{\helpSize}($f_0$: \emph{L-2 norm})
      \end{tabular}\\
      \begin{tabular}{l}
        \greenCode{$f_1($v$)\,=\,$(fold 0 ($\lambda$ (x y) (+ x y)) v)}\\
        \hspace{\helpSize}($f_1$: \emph{Sum vector components})
      \end{tabular}\\
      \begin{tabular}{l}
        \greenCode{$f_2($v,u$)\,=\,$($f_1$ (zip v u ($\lambda$ (x y) (* x y))))}\\
        \hspace{\helpSize}($f_2$: \emph{Dot product})
      \end{tabular}\\
      ...
      \begin{tabular}{l}
        ...
        \hspace{\helpSize}($f_3$: \emph{Sum (list of) vectors})
      \end{tabular}\\
      \begin{tabular}{l}
        \greenCode{$f_4($x$)\,=\,$(/ x (+ 1 1))}\\
        \hspace{\helpSize}($f_4$: \emph{Divide by two})
      \end{tabular}\\
      ...
      \end{tabular}\\
      \begin{tabular}{l}
        \greenCode{$f_6($v$)\,=\,$(power ($f_0$ v) ($f_4$ 1))}\\
        \hspace{\helpSize}($f_6$: \emph{n-dimensional vector length})
      \end{tabular}\\
    ...
    \begin{tabular}{l}
      \greenCode{$f_7($a,b,v$)\,=\,$(map ($\lambda$ (x)}\\
      \greenCode{\phantom{$f_7($a,b}(* (/ (* (/ x ($f_0$ v)) a) ($f_6$ v)) b)) v)}\\
      \hspace{\helpSize}($f_7$: Inverse square law)
      \end{tabular}
    \end{tabular}
...
a DSL containing a modern repertoire of functional programming idioms
