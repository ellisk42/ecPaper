...
\vinvention{surround}{appendSingle}{
    ...
    \begin{scope}[shift={(0,-15)}]
      \invention{filter}{0,0}{
        ${\color{\inventionColor}f_0} = $\mcode{($\lambda$ (p l)\\ (fold ($\lambda$ (x a)\\ (if (p x) (cons x a) a))\\ nil l))} 
        }{higher-order `filter'}

      \invention{three}{[yshift=-\verticalSpacing]filter.center}{\footnotesize ${\color{\inventionColor}f_1} = $\\\mcode{(+ 1 (+ 1 1))}}{The number `3'}
      \invention{prefix}{[yshift=-\verticalSpacing]three.center}{\footnotesize ${\color{\inventionColor}f_2} = $\mcode{($\lambda$ (n l) (map ($\lambda$ (i) (index i l)) (range (+ 1 n))))}}{First $n$ elements}
      \invention{single}{[xshift=\horizontalSpacing]filter.center}{\footnotesize ${\color{\inventionColor}f_3} = $\mcode{($\lambda$ (z l) (fold ($\lambda$ (x y) (cons x y)) z l))}}{Append element}
      \invention{for}{[yshift=-\verticalSpacing]single.center}{\footnotesize ${\color{\inventionColor}f_4} = $\mcode{(+ 1 ${\color{\inventionColor}f_1}$)}}{The number `4'}
      \invention{Max}{[yshift=-\verticalSpacing]for.center}{\footnotesize ${\color{\inventionColor}f_5} = $\mcode{($\lambda$ (l) %
          (car (${\color{\inventionColor}f_0}$ ($\lambda$ (x) (nil? (${\color{\inventionColor}f_0}$ l ($\lambda$ (z) (> z x))))) l)))}}{Max of list}
      \invention{largest}{[xshift=\horizontalSpacing]single.center}{\footnotesize ${\color{\inventionColor}f_6} = $\mcode{($\lambda$ (l n) %
          (${\color{\inventionColor}f_5}$ (${\color{\inventionColor}f_0}$ ($\lambda$ (x) (> n (length (${\color{\inventionColor}f_0}$ ($\lambda$ (y) (> x y)) l)))) l)))}}{$n^{\text{th}}$ largest element}
      \vinvention{count}{largest}{\footnotesize ${\color{\inventionColor}f_7} = $\mcode{($\lambda$ (x l) %
          (length (${\color{\inventionColor}f_0}$ ($\lambda$ (y) (= x y)) l)))}}{count}
      \vinvention{weird}{count}{\footnotesize ${\color{\inventionColor}f_8} = $\mcode{($\lambda$ (p l) %
      ...
      \node(t3)[align=left] at ([xshift=3.75cm]t2.center) {
        ...
        \footnotesize $f(\text{\mcode{z}}) = $\mcode{(map ($\lambda$ (i)}\\\hspace{0.5cm}\mcode{ (${\color{\inventionColor}f_6}$ z i)) }\\\hspace{0.5cm}\mcode{(+ 1 (range (length z)))}
      };
