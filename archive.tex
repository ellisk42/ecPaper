...
(Figure~\ref{logoPrimitives}, middle) -- without supervision the agent
...
LOGO graphics,
and learns parametric `options' for building blocks towers (Figure~\ref{tower}, bottom left),
inferring concepts like arches, staircases, bridges and brick walls.
\begin{figure}
  \centering  \begin{tabular}{cc}
    \toprule
    \multicolumn{2}{c}{Subset of 112 Tasks}\\\midrule
    \multicolumn{2}{c}{\includegraphics[width = \textwidth]{figures/tower12.png}}\\\midrule \\
    ...
    \\\bottomrule 
    \end{tabular}
  \caption{\textbf{Top}: Twelve (out of 112) tower building tasks. Agent writes a program controlling a `hand' that builds the target tower. \textbf{Bottom left}: Three learned library routines. These components act like parametric options~\cite{stolle2002learning},
