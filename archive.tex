...
\begin{figure}
  \begin{tabular}{cc}
    ...
    \\\bottomrule 
    \end{tabular}
  \caption{Learned subroutines for building towers out of Lego-style blocks. These subroutines act like parametric options~\cite{options},
    giving higher-level building blocks that the agent can use to plan.}
\end{figure}



\subsubsection{Symbolic Regression: Programs from visual input}\label{regressionSection}
...
\begin{figure}
  \begin{tabular}{ccc}
    ...
    \includegraphics[width = 5cm]{figures/rationalLearningCurve_batched.png}&
  \end{tabular}
