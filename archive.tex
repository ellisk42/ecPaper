...
\begin{figure}
  ...
  \begin{tikzpicture}
    \node at (0,0) (f1){Frontier$_1$};
    \node at ([yshift = -1cm]f1.south) (f2){Frontier$_2$};
    \node at ([yshift = -1cm]f2.south) (ff){$\vdots$};
    ...
    \node[align = right](d) at ([xshift = 1.5cm,yshift = 1cm]c.east) {DSL $\mathcal{D}$};
    \node[align = right](t) at ([xshift = 1.5cm,yshift = -1cm]c.east) {Parameters $\theta$};
    \draw [-> ] (c.east) -- (d.west);
    \draw [-> ] (c.east) -- (t.west);
